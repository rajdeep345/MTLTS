# -*- coding: utf-8 -*-
"""Copy of bert_tree_lstm_verification_oneDS_812_val.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1bKg1AKoYFlCwSgs8y2Umiecjyn09I5cz
"""
...
# not necessary use it if you want to check gpu space and details
...
tree_path = './drive/My Drive/IIT_Kgp/Research/Disaster/BTP_Chandana_Vishnu/verification/Data/Parsed-Trees-Pad32_FeatBERT_Depth5_maxR5/'
...
# tree_path = './drive/My Drive/IIT_Kgp/Research/Disaster/BTP_Chandana_Vishnu/verification/Data/Parsed-Trees-Pad32_FeatBERT40_Depth5_maxR5/'
path = "./drive/My Drive/IIT_Kgp/Research/Disaster/BTP_Chandana_Vishnu/verification/Models/"
IN_FEATURES = 768
OUT_FEATURES = 128
NUM_ITERATIONS = 5
BATCH_SIZE = 16
name = path + "stl_verification_featBERT40_e10.pt"
...
for test in ['ottawashooting.txt']:
    test_file = test
    # model = TreeLSTM(IN_FEATURES, OUT_FEATURES, mode="cls").train()
    # model.cuda()
